...
//
//    // Materials
//    shared_ptr<lambertian> left_red = make_shared<lambertian>(color(1.0, 0.2, 0.2));
//    shared_ptr<lambertian> back_green = make_shared<lambertian>(color(0.2, 1.0, 0.2));
//    shared_ptr<lambertian> right_blue = make_shared<lambertian>(color(0.2, 0.2, 1.0));
//    shared_ptr<lambertian> upper_orange = make_shared<lambertian>(color(1.0, 0.5, 0.0));
//    shared_ptr<lambertian> lower_teal = make_shared<lambertian>(color(0.2, 0.8, 0.8));
//
//    // Quads
...
//    shared_ptr<diffuse_light> light = make_shared<diffuse_light>(color(15, 15, 15));
//
...
//    shared_ptr<lambertian> white = make_shared<lambertian>(color(.73, .73, .73));
//    shared_ptr<lambertian> green = make_shared<lambertian>(color(.12, .45, .15));
//    shared_ptr<diffuse_light> light = make_shared<diffuse_light>(color(7, 7, 7));
//
//    world.add(make_shared<quad>(point3(555, 0, 0), vec3(0, 555, 0), vec3(0, 0, 555), green));
//    world.add(make_shared<quad>(point3(0, 0, 0), vec3(0, 555, 0), vec3(0, 0, 555), red));
...
int main()
{
    ...
    // Light Sources
    shared_ptr<material> empty_material = shared_ptr<material>();
