...
namespace DX
{
    ...
    public:
        ...
        inline IDXGIFactory4* GetDXGIFactory() const { return m_dxgiFactory.Get(); }
        ...
        inline ID3D12Resource* GetRenderTarget() const { return m_renderTargets[m_backBufferIndex].Get(); }
        inline ID3D12Resource* GetDepthStencil() const { return m_depthStencil.Get(); }
        inline ID3D12CommandQueue* GetCommandQueue() const { return m_commandQueue.Get(); }
        inline ID3D12CommandAllocator* GetCommandAllocator() const { return m_commandAllocators[m_backBufferIndex].Get(); }
        ...
        inline LPCWSTR                     GetAdapterDescription() const { return m_adapterDescription.c_str(); }
